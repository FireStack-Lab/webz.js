...
var _initialiseProps = function _initialiseProps() {
  ...
  this.send = function (data) {
    ...
    var payload = _jsonRpc2.default.toPayload(data.method, data.params);
    var result = _this.provider.send(payload);

    if (!_jsonRpc2.default.isValidResponse(result)) {
  ...
  this.sendBatch = function (data, callback) {
    ...
    var payload = _jsonRpc2.default.toBatchPayload(data);
