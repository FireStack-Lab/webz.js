...
var HttpProvider = function HttpProvider(url, timeout, user, password, headers) {
  ...
  this.instance = function () {
    var request = _axios2.default.create({ url: '' + _this.url });
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return _this.axios.post({ data: _qs2.default.stringify(payload) });
  ...
  this.sendAsync = function (payload, callback) {
    ...
    _this.axios.post({ data: _qs2.default.stringify(payload) }).then(function (response) {
      callback(response);
    }).catch(function (err) {
      return callback(err);
    });
