...
var HttpProvider = function HttpProvider(url, timeout, user, password, headers) {
      ...
      return _regenerator2.default.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              request = _this.instance();
              _context.prev = 1;
              _context.next = 4;
              return request(_qs2.default.stringify(payload));
  ...
  this.sendAsync = function (payload, callback) {
    var request = _this.instance();
    request(_qs2.default.stringify(payload)).then(function (response) {
      callback(response);
    }).catch(function (err) {
      return callback(err);
    });
